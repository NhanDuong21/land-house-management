...
<t:layout 
    ...
    cssFile="${pageContext.request.contextPath}/assets/css/views/editMaintenance.css">
    ...
    <div class="em-container">
        <div class="em-header">
            <div>
                <h2>
                    Maintenance Request #${m.requestId}
                </h2>
                <p>
                    Update maintenance status and view request details.
                </p>
            </div>
            <a class="em-btn"
        ...
        <div class="em-card">
            ...
            <c:choose>
                ...
                <c:when test="${not empty m.imageUrl}">
                    <img class="em-image"
                         src="${pageContext.request.contextPath}/assets/images/maintenance/${m.imageUrl}"
