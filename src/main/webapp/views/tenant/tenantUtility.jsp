...
<layout:layout title="Tenant Utility"
               ...
               jsFile="${pageContext.request.contextPath}/assets/js/pages/tenantUtility.js">

    <div class="tu-bg-orb tu-bg-orb-1"></div>
    <div class="tu-bg-orb tu-bg-orb-2"></div>
    <div class="tu-bg-grid"></div>

    <div class="mb-container">

        <!-- HEADER -->
        <div class="tu-header tu-reveal tu-reveal-up">
            <h2>Utility Services</h2>
            <p>Manage your utility service subscriptions</p>
        </div>

        <!-- BANNER -->
        <div class="tu-banner tu-reveal tu-reveal-zoom">
            <div>
                <h4>Available Services</h4>
                <p>
                    Subscribe to additional services to enhance your living experience.
                    Select the services you want and confirm your selection.
                </p>
            </div>

            <button class="tu-manage-btn tu-btn-ripple"
                    type="button"
                    data-open-modal="manageModal">
                Manage Services
            </button>
        </div>

        <!-- CARDS -->
        <div class="tu-cards tu-stagger">
            <c:forEach var="u" items="${utility}">
                <div class="tu-card tu-reveal tu-reveal-up">
                    <div class="tu-card-glow"></div>
            ...
            <c:if test="${empty utility}">
                <p class="tu-empty-state">No utility services available.</p>
            </c:if>
        </div>

        <!-- Manage Services Modal -->
        <div id="manageModal" class="tu-modal-overlay" aria-hidden="true">
            <div class="tu-modal-content" role="dialog" aria-modal="true" aria-labelledby="tuManageTitle">

                <!-- Modal Header -->
                <div class="tu-modal-header">
                    <div>
                        <h4 id="tuManageTitle">Select Utility Services</h4>
                        <small>Choose additional services you would like to subscribe to</small>
                    </div>

                    <button class="tu-modal-close"
                            type="button"
                            data-close-modal="manageModal">×</button>
                </div>
                ...
                <c:if test="${isBillPaid}">
                    <div class="tu-lock-alert">
                        <i class="bi bi-lock-fill"></i>
                        <span>Your bill is currently being processed and cannot be modified.</span>
                    </div>
                </c:if>
                ...
                <form action="${pageContext.request.contextPath}/tenant/utility" method="POST">
                    ...
                    <div class="tu-modal-footer">
                        <button type="button"
                                class="tu-btn-cancel"
                                data-close-modal="manageModal">
                            Cancel
                        </button>

                        <button type="submit" class="tu-btn-confirm tu-btn-ripple">
