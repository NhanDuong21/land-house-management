(function () {
  ...
  function buildSummary() {
    ...
    summary.innerHTML = `
      ...
      <div class="mcc-summary-grid">
        ...
        <div class="mcc-summary-item">
          <div class="mcc-summary-label">Email</div>
          <div class="mcc-summary-value" id="mccSummaryEmail">-</div>
        </div>
        <div class="mcc-summary-item">
          <div class="mcc-summary-label">Phone</div>
          <div class="mcc-summary-value" id="mccSummaryPhone">-</div>
        </div>
      </div>
    `;
  ...
  function updateSummary() {
    ...
    setText("mccSummaryTenant", tenantNameInput.value.trim() || "-");
    ...
    setText("mccSummaryEmail", emailInput.value.trim() || "-");
    setText("mccSummaryPhone", phoneInput.value.trim() || "-");
  }
