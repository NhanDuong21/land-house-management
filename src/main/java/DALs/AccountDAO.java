...
//                     acc.setCreatedAt(rs.getObject("created_at", java.time.LocalDateTime.class));
//                     acc.setUpdatedAt(rs.getObject("updated_at", java.time.LocalDateTime.class));
//                     return acc;
//                 }
//             }
...
// FROM            ACCOUNT_ROLES INNER JOIN
//                          ACCOUNTS ON ACCOUNT_ROLES.account_id = ACCOUNTS.account_id INNER JOIN
//                          ROLES ON ACCOUNT_ROLES.role_id = ROLES.role_id
// WHERE ACCOUNT_ROLES.account_id = ? AND ACCOUNT_ROLES.is_active = 1
//     """;
...
//             }
//         } catch (SQLException e) {
//             System.out.println("GET ROLES ERROR: " + e.getMessage());
//         }
...
//     //     String sql = "UPDATE ACCOUNTS SET token = ? WHERE account_id = ?";
//     //     try (PreparedStatement ps = connection.prepareStatement(sql)) {
